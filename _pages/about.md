...
My research interests are centered around **efficient LLM inference and adaptation**, **machine learning systems**, and **responsible AI**. Here is a copy of my [CV](https://drive.google.com/file/d/1_nmI6PbiMfAH85MrOSnA6IIyZP2Sw-k6/view?usp=drive_link).

# News
* **03/23/2026**: Our USC team launched [*ClawGang*](https://clawgang.ai) — infrastructure for making agent memory valuable, tradable, and verifiable. Every API token an agent spends becomes certifiable wealth that can be resold.
