...
My research interests are centered around machine learning systems, federated learning, and responsible AI (especially for large language models). Here is a copy of my [CV](https://drive.google.com/file/d/1_nmI6PbiMfAH85MrOSnA6IIyZP2Sw-k6/view?usp=drive_link).

# News
* **10/15/2024**: Our paper "[Enabling Resource-Efficient On-Device Fine-Tuning of LLMs Using Only Inference Engines](https://arxiv.org/pdf/2409.15520)" has been accepted by NeurIPS [EMNLP](https://neurips2024-enlsp.github.io/) workshop 2024. See you in Vancouver, Canada!
